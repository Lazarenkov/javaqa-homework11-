...
public class PosterManagerUserResultLengthAboveEquivalenceNegativeTest {
    PosterManager item = new PosterManager(12);
    ...
    public void shouldReturnLastItemsInReversedOrder() {
        ...
        PosterItem[] expexted = {item11, item10, item9, item8, item7, item6, item5, item4, item3, item2, item1};
